...
namespace Character
{
    public abstract class CharacterUI : MonoBehaviour, ICharacter
    {
        ...
        [SerializeField] protected SO_GameUIColor so_GameUIColor;
        
        public virtual void Initialize()
        {
            characterMainController.components.GetComponentInGameObjects<IHealth>().OnChangedHealth += OnChangeHealth;
        }
